...
// @homepage     https://gitee.com/hanj-cn
// @supportURL   https://gitee.com/hanj-cn/directory-library-script
// @updateURL    https://gitee.com/hanj-cn/directory-library-script/raw/master/mlk.user.js
// @downloadURL  https://gitee.com/hanj-cn/directory-library-script/raw/master/mlk.user.js
// @source       https://gitee.com/hanj-cn/directory-library-script/blob/master/mlk.user.js
// @grant        unsafeWindow
// @grant        GM_setValue
// @grant        GM_getValue
...
(function () {
  ...
  function addStartBtn() {
    ...
    if (
      ...
      //添加操作按钮
      $("body").prepend("<button id='startBtn'>操作名录库</button>");
        ...
        if (GM_getValue("data") != null) {
          ...
          if (itemNum >= 1) {
            ...
            if (first) {
              ...
              //不是首次
              var resultSize = $("#dbgData > tbody").children().length;
              if (resultSize == 3) {
                //说明只有一条数据，点击第一条数据
                ...
                //异常
                console.log(
                  "搜索结果共" + (resultSize - 2) + "条，程序终止，请自行判断"
                );
                alert(
                  "搜索结果共" + (resultSize - 2) + "条，程序终止，请自行判断"
                );
  ...
  function addInitBtn() {
    ...
    if (
      ...
      //添加按钮
      $("#startBtn").after("<button id='initBtn'>初始化</button>");

      //点击事件
      $("#initBtn").click(function () {
        //输入窗口
        var mlkData = prompt("请在下面粘贴数据，至少粘贴三条");
